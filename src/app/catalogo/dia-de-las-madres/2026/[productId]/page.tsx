      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <div  className="text-rose-500 hover:text-rose-600 font-medium flex items-center justify-center gap-2">
            <ArrowLeft className="w-4 h-4" onClick={() => router.push(`/catalogo/dia-de-las-madres/2026`)}/>
            Back to Home
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 px-4 h-16 flex items-center justify-between">
        ...
        >
          <ArrowLeft className="w-6 h-6" onClick={() => router.push(`/catalogo/dia-de-las-madres/2026`)} />
        </div>
        ...
        <div className="max-w-screen-md mx-auto p-6 sm:p-8 space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-600 leading-relaxed text-lg whitespace-pre-line">
              Combina flores frescas de alta calidad con una selección armoniosa de colores, texturas y follajes, creando piezas únicas que destacan por su elegancia y estilo. Ideales para celebrar momentos especiales, expresar sentimientos o decorar espacios, nuestros arreglos son elaborados con atención al detalle para garantizar frescura, durabilidad y una presentación impecable.
            </p>
          </div>
