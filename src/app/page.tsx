...
export default function Home() {
	return (
		<div className={'min-h-screen flex flex-col items-center justify-center py-10 font-bold ' + avenir.className}>
			...
			<div className='flex flex-col sm:flex-row space-x-4 space-y-4 sm:space-y-0 mt-8'>
